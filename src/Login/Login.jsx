...
class Login extends React.Component {
  ...
  login = (e) => {
    ...
    fetch(`http://localhost:3001/sica/api/authenticateSICA`, {
      method: "POST",
      headers: {
                ...
                <div className="profile__fields">
                  <div className="field">
                    <FormControl className={classes.formControl}>
                      <InputLabel shrink htmlFor="username-tag">
                        {" "}
                        Tipo de usuario
                      </InputLabel>
                      <Select
                  ...
                  <div className="field">
                    <input
                      ...
                      pattern=".*\S.*"
                    />
                    <label htmlFor="fieldUser" className="label label1">
                      Username
                    </label>
                  </div>
                  <div className="field">
                    <input
                      ...
                      pattern=".*\S.*"
                    />
                    <label htmlFor="fieldPassword" className="label label2">
                      Password
                    </label>
                  </div>
                  {!this.state.loading && (
