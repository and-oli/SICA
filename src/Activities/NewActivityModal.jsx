...
class NewActivityModal extends React.Component {
  ...
  handleChangeDropdown = (e) => {
    ...
    this.setState({
      ...
      route: conceptsRoutes[e.target.value],
      otro,
    });
  };
  render() {
    ...
    return (
      ...
      >
        <div
          ...
          className={classes.modalUploadActivity}
        >
          <Arrow
          ...
          <FormControl className="new-activity-properties">
            {!this.props.nuevoLote && (
              <div style={{ width: "100%" }}>
                <InputLabel shrink htmlFor="concept-label-placeholder">
                  {" "}
                  Concepto
                </InputLabel>
                <Select
                  ...
                  input={
                    <Input name="concept" id="concept-label-placeholder" />
                  }
                  displayEmpty
                  name="concept"
                  style={{ width: "100%" }}
              ...
              <div>
                ...
                <Select
                  ...
                  onChange={(e) => {
                    this.setState({
                      route: "nuevoLote",
                      typeOfLot: e.target.value,
                      concept: `Nuevo lote: ${e.target.value}`,
                    });
                  }}
