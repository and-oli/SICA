    ...
    if(this.props.results){
      ...
      <TableRow >{
        this.props.results[0].map((cell,j) => {
          return (
            <TableCell key = {j} align="center" style={{ fontWeight: "bold", fontSize: "16px" }}>{cell}</TableCell>
          )
        })
      }
    </TableRow>
                ...
                <Table className={classes.table}>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="center" style={{ fontWeight: "bold", fontSize: "16px" }}>Cantidad</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {
