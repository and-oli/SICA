...
class ExportTableModal extends React.Component{
  ...
  exportConsolidate=()=>{
    ...
    fetch(`http://localhost:3001/sica/api/casosDescargar?estado=${this.props.stateT}&f1=${this.props.f1}&f2=${this.props.f2}&type=${this.props.type}&module=${this.props.module}`, {
      method: 'GET',
      headers: {
  ...
  generate5Files= ()=>{
    ...
    let generateSingleFile = (index)=>{
      if (index < 6){
        ...
        fetch(`http://localhost:3001/sica/api/casosDescargarMil?estado=${this.props.stateT}&f1=${this.props.f1}&f2=${this.props.f2}&type=${this.props.type}${idQuery}&module=${this.props.module}`, {
          method: 'GET',
          headers: {
            'x-access-token': localStorage.getItem("SICAToken")
          },
